...
// Replaying a run navigates to /debugger and hands the run over via
// router state; DebuggerPage reads it back out on mount.
function HistoryPage() {
  const navigate = useNavigate()

  function handleReplay(run) {
    navigate('/debugger', { state: { replayRun: run } })
  }
